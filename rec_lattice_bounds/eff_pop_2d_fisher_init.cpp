...
int main (int argc, char * argv[]){
	...
	//data files
	ofstream flog, fpop, fhet, fprof,fsects,frough_64,frough_128,frough_256,frough_512;
	time_t time_start;
	...
	string rough256Name = "rough_256_" + param_string + date_time.str() + ".txt";
	string rough512Name = "rough_512_" + param_string + date_time.str() + ".txt";




	string folder = "KPZ/sim_data/";
	//string folder = "";s
    ...
    frough_256.open(folder+rough256Name);
    frough_512.open(folder+rough512Name);
