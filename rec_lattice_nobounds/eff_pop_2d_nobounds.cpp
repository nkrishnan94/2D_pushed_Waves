...
unsigned long K  = 5000;
unsigned int n_gens = 1;
const int n_demes = 8; 
		...
		for(int i = 0; i < n_demes; i++){
			for(int j = 0; j < n_demes; j++){
				...
				if((arr[0]==0) && (arr[1]==0)){
					cout <<"hi";
					ne_num = 2;
					int neighb_vec_temp = {{1,0},{0,1}};
					for(int ne = 0; ne<ne_num; ne+=){
						for(int k = 0; k<2; k++){
							neighb_vec[ne][k] = neighb_vec_temp[ne][k];
						}
					...
					//neighbs[2][2];
				} else if((arr[0] == 0) && (arr[1] == (n_demes - 1))){
					ne_num = 2;
					int neighb_vec_temp[3][2] = {{1,0},{0,-1}};
					for(int ne = 0; ne<ne_num; ne+=){
						for(int k = 0; k<2; k++){
							neighb_vec[ne][k] = neighb_vec_temp[ne][k];
						}
					...
					//neighbs[2][2];
				} else if(arr[0]==0 && (arr[1]!=0) && (arr[1]!=(n_demes-1)) ){
					//cout <<"bye";
					ne_num = 3;
					neighb_vec_temp[3][2] = {{1,0},{0,-1},{0,1}};
					for(int ne = 0; ne<ne_num; ne+=){
						for(int k = 0; k<2; k++){
							neighb_vec[ne][k] = neighb_vec_temp[ne][k];
						}
					...
					//neighbs[3][2];
				} else if(arr[1]==0 && (arr[0]!=0) && (arr[0]!=(n_demes-1))){
					ne_num = 3;
					neighb_vec_temp[3][2] = {{1,0},{-1,0},{0,1}};
					for(int ne = 0; ne<ne_num; ne+=){
						for(int k = 0; k<2; k++){
							neighb_vec[ne][k] = neighb_vec_temp[ne][k];
						}
					...
					//neighbs[3][2];
				} else if(arr[1]==(n_demes-1) && (arr[0]!=0) && (arr[0]!=(n_demes-1))){
					ne_num = 3;
					neighb_vec_temp[3][2] = {{1,0},{0,-1},{-1,0}};
					for(int ne = 0; ne<ne_num; ne+=){
						for(int k = 0; k<2; k++){
							neighb_vec[ne][k] = neighb_vec_temp[ne][k];
						}
				...
				} else if((arr[0]==(n_demes-1)) && (arr[1]== 0)){
					ne_num = 2;
					neighb_vec_temp[2][2] = {{-1,0},{0,1}};
					for(int ne = 0; ne<ne_num; ne+=){
						for(int k = 0; k<2; k++){
							neighb_vec[ne][k] = neighb_vec_temp[ne][k];
						}
					...
					//neighbs[2][2];
				} else if((arr[0]==(n_demes-1)) && (arr[1]== (n_demes -1))){
					ne_num = 2;
					neighb_vec_temp[2][2] = {{-1,0},{0,-1}};
					for(int ne = 0; ne<ne_num; ne+=){
						for(int k = 0; k<2; k++){
					...
					//neighbs[2][2];
				} else if(arr[0]==(n_demes-1)&& (arr[1]!=0) && (arr[1]!=(n_demes-1))){
					ne_num = 3;
					neighb_vec_temp[3][2] = {{-1,0},{0,-1},{0,1}};
					for(int ne = 0; ne<ne_num; ne+=){
						for(int k = 0; k<2; k++){
					...
					ne_num = 4;
					neighb_vec_temp[4][2] = {{1,0},{0,-1},{0,1},{-1,0}};
					for(int ne = 0; ne<ne_num; ne+=){
						for(int k = 0; k<2; k++){
							neighb_vec[ne][k] = neighb_vec_temp[ne][k];
						}
				...
				for(int ne=0; ne < ne_num; ne++){
					cout << neighb_vec[ne][0];

					neighbs[ne][0] = (arr[0] + neighb_vec[ne][0]);
					neighbs[ne][1] = (arr[1] + neighb_vec[ne][1]);
					cout << arr[0] << ", " << arr[1] << "\n";
					cout << neighbs[ne][0]<<", " << neighbs[ne][1] << "\n";
